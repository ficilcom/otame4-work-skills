...
「今の仕事以外に何ができるか」「やりたいことが分からない」から、**調べて確かめられる仕事の候補**を作る。本人の経験と候補の仕事内容をつなぎ、根拠、足りない情報、試し方を示す。転職や職種変更を前提にせず、現職内での担当変更や同職種の別環境も視野に入れる。
...
- **候補と次の確認を会話内で返す。** 下の成果物を相談の深さに合わせて使う。候補を足すだけでなく、何が分かったら残す・修正する・いったん外すかを本人が考えられるようにする。

## 成果物

初回は短い整理と次の質問でよい。候補が作れる段階では、次を一緒に示す。

| 候補となる仕事・担当 | 本人の経験との接点 | 実際に確認した業務・出典・時点 | 未経験・未確認の業務や必須条件 | 希望との衝突・候補を見直す材料 |
| --- | --- | --- | --- | --- |

次に、本人が確かめたい候補について「小さな確認・体験」「何を見れば判断が変わるか」「時間・費用などの上限」「やめる条件」「見直す時期」を提案する。選ばれていなければ提案のまま残す。作業体験での感想や成果を、採用見込み・適性の証明にしない。

最後に、本人が話した事実、こちらが作った仮説、未確認の条件を区別した短い要約を残す。ここでいう要約は会話への出力であり、ファイル保存ではない。

## 他の相談とのつなぎ方

転職するか自体に迷っているなら `job-change-decision`、詳しい経験の整理は `career-inventory`、企業選びの基準は `job-hunting-axis`、見つけた求人の精査は `job-posting-analysis` が使える。どれも前提条件ではない。未インストールなら、本人の事実と未確認事項をまとめてそのまま相談を続ける。利用者が職種探索を望んでいる間は、転職判断のやり直しを要求しない。
